...
const DECLARATOR_TYPES = new Set(["lexical_declaration", "variable_declaration"]);
...
function findFirstNodeOfType(root: TreeSitter.Node, types: Set<string>): TreeSitter.Node | null {
